...
export interface Photo {
  ...
  public_url: string
  thumb_url?: string           // 200×200 thumbnail generated by the process-image Edge Function
  caption?: string
  taken_at?: string
  width?: number
  height?: number
...
export interface SharedAccess {
  ...
  permission:     SharePermission // 'read' = view only, 'write' = can create/edit/delete
  guest_name:     string | null   // optional label set by the owner
  guest_email:    string | null   // if set, only this email can accept the invite
...
export interface CreateInviteResult {
  row:       SharedAccess
  inviteUrl: string
  label:     string | null   // name or email set by owner, for the toast
}
